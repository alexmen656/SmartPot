...
def main():
    ...
    # SPI-Konfiguration mit Standard SPI0-Pins
    spi = machine.SPI(0, 
                      baudrate=40000000,
                      polarity=1, 
                      phase=0)
    ...
    # Display initialisieren (240x240 Pixel)
    ...
    # Test-Muster anzeigen
    print("Fülle Display mit verschiedenen Farben...")
    ...
    color_names = ["Rot", "Grün", "Blau", "Gelb", "Cyan", "Magenta", "Weiß"]
    ...
    # Einfache Grafiken zeichnen
    print("Zeichne Grafiken...")
    display.fill(BLACK)
    
    # Rechtecke zeichnen
    display.rect(10, 10, 50, 30, RED)
    display.fill_rect(70, 10, 50, 30, GREEN)
    
    # Linien zeichnen
    display.line(10, 50, 100, 80, BLUE)
    display.line(10, 80, 100, 50, YELLOW)
    
    # Horizontal und vertikal Linien
    display.hline(10, 100, 100, WHITE)
    display.vline(120, 50, 50, CYAN)
    
    # Einzelne Pixel setzen
    for i in range(20):
        for j in range(20):
            color = color565(i*12, j*12, 128)
            display.pixel(150 + i, 150 + j, color)
