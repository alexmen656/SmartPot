...
def main():
    ...
    # Einfache Tests mit einzelnen hellen Pixeln
    print("Teste einzelne helle Pixel...")
    try:
        # Bildschirm komplett weiß füllen
        print("Fülle mit Weiß...")
        display.fill(WHITE)
        time.sleep(2)
        
        # Bildschirm komplett rot füllen  
        print("Fülle mit Rot...")
        display.fill(RED)
        time.sleep(2)
        
        # Schwarzer Hintergrund
        print("Fülle mit Schwarz...")
        display.fill(BLACK)
        time.sleep(1)
        
        # Große weiße Rechtecke testen
        print("Zeichne große weiße Rechtecke...")
        display.fill_rect(0, 0, 120, 120, WHITE)
        time.sleep(1)
        display.fill_rect(120, 120, 120, 120, RED)
        time.sleep(1)
        
        # Test mit anderen Display-Modi
        print("Teste verschiedene Orientierungen...")
